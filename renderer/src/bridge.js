const fallback = {
  ...
  setBreakMode: async () => ({ ok: false, breakMode: false }),
  getBreakMode: async () => ({ breakMode: false }),
  showMainWindow: async () => ({ ok: false }),
...
const api = {
  ...
  setBreakMode: (enable) => current().setBreakMode(enable),
  getBreakMode: () => current().getBreakMode(),
  showMainWindow: () => current().showMainWindow(),
